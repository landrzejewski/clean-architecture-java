package pl.training.payments.config;
...
public class PaymentsConfiguration {
    ...
    public Advisor cacheAdvisor(CacheAspect cacheAspect) {
        ...
        pointcut.setExpression("execution(pl.training.payments.api.model.Card pl.training.payments.application.GetCardService.getCard(pl.training.payments.api.model.CardNumber))");
